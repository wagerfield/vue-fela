...
Installing `VueFela` will create a [Fela Renderer][fela-renderer] instance ([unless one is provided](#custom-fela-renderer)) and add it to Vue's prototype on a `$fela` property.
